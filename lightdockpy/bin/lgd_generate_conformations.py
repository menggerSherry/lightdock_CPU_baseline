...
if __name__ == "__main__":
    ...
    # print(np.array(receptor.atom_coordinates))
    # Ligand
    structures = []
    ...
    # print(receptor.atom_coordinates[0])
    # print(nmodes_rec.shape)
    # print(receptor.nm_mask.shape)
    for i in range(num_conformations):
        ...
        if nmodes_rec is not None and nmodes_rec.any():
            # print(2222)
            try:
                # print(nmodes_rec[0].shape)
                # print(rec_extents[0][0])
