...
class Glowworm(object):
    ...
    def is_neighbor(self, other, squared_vision_range):
        ...
        # if self.step == 2:
        #     print(self.luciferin)
        if self != other and self.luciferin < other.luciferin:
            # if self.step == 2:
            #     print("self")
            #     print(self.landscape_positions[0].ligand_reference_points)
            #     print("other")
            #     print(other.landscape_positions[0].ligand_reference_points)
            #     rmsd2 = np.sum(
            #         (self.landscape_positions[0].ligand_reference_points 
            #          - other.landscape_positions[0].ligand_reference_points) ** 2
            #     ) / len(self.landscape_positions[0].ligand_reference_points)
            #     print("rmsd:",rmsd2)
                # print("distance:",self.distance2(other))
